...
<body class="bg-zinc-900 h-screen w-screen">
    <div class="fixed container bg-gradient-to-r max-w-full w-full h-12 from-cyan-300 via-cyan-400 to-blue-600 z-50">

    </div>
    
    <div class="carousel relative rounded relative overflow-hidden shadow-xl h-3/6">
        <div class="carousel-inner mt-14 relative overflow-hidden w-full h-5/6">
            <!--Slide 1-->
    ...
    <div class="container absolute mx-auto px-2 inset-x-0 bottom-0 w-full lg:h-2/5">
        <div class="flex overflow-x-auto -mx-1 h-full">
            <!-- Column -->
            <div class="my-1 px-1 w-full flex-shrink-0 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">

                <!-- Article -->
                <article class="overflow-hidden rounded-lg shadow-lg bg-neutral-300 h-full">
            ...
            <div class="my-1 px-1 w-full flex-shrink-0 lg:w-1/4 lg:px-4 lg:my-4">
                <article class="w-full h-full bg-neutral-300 rounded-lg">
